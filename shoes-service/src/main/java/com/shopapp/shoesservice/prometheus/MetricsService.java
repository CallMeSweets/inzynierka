package com.shopapp.shoesservice.prometheus;
...
public class MetricsService {
    ...
    private void initMetrics() {
        ...
        requestCounter = Counter.builder("total_shoes_service_request")
                .description("Total number of requests")
                .register(meterRegistry);

        logFileSize = meterRegistry.gauge("log_file_size_shoes_service", new AtomicLong(0));
    ...
    public void scheduleFreeLogFileSpace() {
        ...
        Path path = Paths.get("logs/shoes-service.log");
        FileStore file = null;
        try {
