package com.shopapp.basketservice.prometheus;
...
public class MetricsService {
    ...
    private void initMetrics() {
        ...
        requestCounter = Counter.builder("total_basket_service_request")
                .description("Total number of requests")
                .register(meterRegistry);

        logFileSize = meterRegistry.gauge("log_file_size_basket_service", new AtomicLong(0));
    ...
    public void scheduleFreeLogFileSpace() {
        ...
        Path path = Paths.get("logs/basket-service.log");
        FileStore file = null;
        try {
