package com.shopapp.clothesservice.prometheus;
...
public class MetricsService {
    ...
    private void initMetrics() {
        ...
        requestCounter = Counter.builder("total_clothes_service_request")
                .description("Total number of requests")
                .register(meterRegistry);

        logFileSize = meterRegistry.gauge("log_file_size_clothes_service", new AtomicLong(0));
    ...
    public void scheduleFreeLogFileSpace() {
        ...
        Path path = Paths.get("logs/clothes-service.log");
        FileStore file = null;
        try {
