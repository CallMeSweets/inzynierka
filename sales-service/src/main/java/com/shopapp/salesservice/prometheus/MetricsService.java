package com.shopapp.salesservice.prometheus;
...
public class MetricsService {
    ...
    private void initMetrics() {
        ...
        requestCounter = Counter.builder("total_sales_service_request")
                .description("Total number of requests")
                .register(meterRegistry);

        logFileSize = meterRegistry.gauge("log_file_size_sales_service", new AtomicLong(0));
    ...
    public void scheduleFreeLogFileSpace() {
        ...
        Path path = Paths.get("logs/sales-service.log");
        FileStore file = null;
        try {
